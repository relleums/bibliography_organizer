...
def main():
    ...
    update.add_argument(
        "--overwrite", action="store_true", help="Overwrite existing icons."
    )

    update = commands.add_parser(
        "ocr", help="Run optical character recognition."
    )
    update.add_argument(
        "--overwrite", action="store_true", help="Overwrite existing ocrs."
    )
